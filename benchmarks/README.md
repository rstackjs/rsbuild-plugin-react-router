...
```sh
node scripts/benchmark/run.mjs scripts/bench-builds.mts --profile=large --mode=dev --iterations=5 --warmup=0
```
...
```sh
node scripts/benchmark/run.mjs scripts/bench-builds.mts --profile=large --mode=dev --dev-routes=0,1,10,200
node scripts/benchmark/run.mjs scripts/bench-builds.mts --profile=large --mode=dev --dev-routes=/,/route-0001
```
...
```sh
node scripts/benchmark/run.mjs scripts/bench-builds.mts --profile=smoke --iterations=1 --warmup=0 --rspack-profile=OVERVIEW
node scripts/benchmark/run.mjs scripts/bench-builds.mts --profile=full --filter=synthetic-1024 --iterations=1 --warmup=0 --rspack-profile=ALL
```
